...
def login(page, context):
    ...
    # Fill mobile number
    page.locator('//input[@type="tel"]').fill('9824818225')  # EDIT THIS
    ...
    if login_successful:
        context.storage_state(path="9824818225_20241113_session_storage.json")
...
def scraper(pincode, start_id, end_id):
    ...
    for pos, pid in enumerate(rows):
        ...
        with sync_playwright() as playwright:
            ...
            context = NewContext(browser, fingerprint=fingerprint, user_agent=user_agent, http_headers=browserforge.headers.HeaderGenerator().generate())
            ...
            if local_cursor.fetchone():
                ...
                update_query = f"""UPDATE INTO pages SET page_hash = '{page_id}' AND status = 'done' WHERE url = '{page.url}' VALUES ('{page.url}', '{pincode}', '{page_id}', 'done')"""
